...
export class StartPagePOM extends AbstractPOM {
    ...
    private tmuxCommandInput?: HTMLInputElement;
    private tmuxCommandSend?: HTMLButtonElement;
    ...
    private linkBackupListener?: EventListener;

    // Tmux-Listener
    private tmuxClickListener?: () => Promise<void>;
    private tmuxEnterListener?: (e: KeyboardEvent) => void;
    ...
    async loadPage(): Promise<void> {
        ...
        if (isPrivilegedUser) {
            this.tmuxCommandInput = document.getElementById("TmuxCommandInput") as HTMLInputElement;
            this.tmuxCommandSend = document.getElementById("TmuxCommandSend") as HTMLButtonElement;
            ...
            this.tmuxEnterListener = async (e: KeyboardEvent) => {
                if (e.key === "Enter") {
                    e.preventDefault();
        ...
        const updateTmuxOutput = async () => {
            ...
            if (isScrolledToBottom) tmuxOutput.scrollTop = tmuxOutput.scrollHeight;
        };
    ...
    private bindNavbarListeners() {
        ...
        this.linkBackupListener = (e: Event) => {
            e.preventDefault();
